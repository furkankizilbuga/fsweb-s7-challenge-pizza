    ...
    return(
        <main className="flex items-center justify-center bg-red-600 h-96 bg-[url('../Assets/mile1-assets/home-banner.png')] bg-contain bg-no-repeat bg-bottom sm:bg-cover sm:items-start sm:py-52 sm:bg-center sm:h-[950px]">
            <div className="flex flex-col items-center gap-4 sm:gap-8">
                ...
                <button className="font-medium shadow bg-[#FDC913] hover:bg-[#fdab13] px-5 py-2 rounded-full text-sm md:px-10 md:py-3 md:text-lg" data-cy="home-button" onClick={smoothScroll} pizza={pizza} aria-label="order">ACIKTIM</button>
            </div>
        </main>
    )
}