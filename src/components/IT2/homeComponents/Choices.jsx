export default function Choices(props) {
    ...
    return(
        <div className="flex justify-center items-center font-semibold text-sm py-12 font-barlow">
            <div className="flex flex-row flex-wrap justify-center gap-4 ">
                <div className={"flex items-center w-40 gap-3 py-2 rounded-full justify-center " + customCSS}>
